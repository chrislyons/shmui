// OrbFragment.glsl - Fragment shader for orb visualization
// Ported from orb.tsx
...
// Map grayscale value to a 4-color ramp
...
void main() {
    ...
    // Add noise for flow-like distortion
    ...
    // Oval centers in polar coordinates
